<%@ Page Title="Cazuri Iesite" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" EnableEventValidation="false"  CodeBehind="Iesite.aspx.cs" Inherits="ProbatiuneApp.Iesite" %>
...
<asp:Content runat="server" ID="FeaturedContent" ContentPlaceHolderID="FeaturedContent">
    <section class="featured">
        ...
        <div class="form-wrapper cf">
            ...
            <button id="Button1" type="submit" runat="server" onserverclick="SearchButtonInactiv_Click">Search</button>
        </div>
    </section>
</asp:Content>
